...
import { l as log, v as common, g as getConfig, M as render, H as utils, aC as generateId, I as clear, o as getAccTitle, q as setAccTitle, n as getAccDescription, m as setAccDescription, C as setDiagramTitle, D as getDiagramTitle } from "./mermaid-DiDd0-cy.js";
...
class StateDB {
  ...
  getDirection() {
    var _a;
    return ((_a = this.getDirectionStatement()) == null ? void 0 : _a.value) ?? DEFAULT_DIAGRAM_DIRECTION;
  }
  setDirection(dir) {
...
__publicField(StateDB, "relationType", {
  AGGREGATION: 0,
  EXTENSION: 1,
  COMPOSITION: 2,
  DEPENDENCY: 3
