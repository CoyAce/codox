...
class QuadrantBuilder {
  ...
  getDefaultConfig() {
    ...
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: ((_a = config$1.quadrantChart) === null || _a === void 0 ? void 0 : _a.chartWidth) || 500,
      chartWidth: ((_b = config$1.quadrantChart) === null || _b === void 0 ? void 0 : _b.chartHeight) || 500,
      titlePadding: ((_c = config$1.quadrantChart) === null || _c === void 0 ? void 0 : _c.titlePadding) || 10,
      titleFontSize: ((_d = config$1.quadrantChart) === null || _d === void 0 ? void 0 : _d.titleFontSize) || 20,
      quadrantPadding: ((_e = config$1.quadrantChart) === null || _e === void 0 ? void 0 : _e.quadrantPadding) || 5,
      xAxisLabelPadding: ((_f = config$1.quadrantChart) === null || _f === void 0 ? void 0 : _f.xAxisLabelPadding) || 5,
      yAxisLabelPadding: ((_g = config$1.quadrantChart) === null || _g === void 0 ? void 0 : _g.yAxisLabelPadding) || 5,
      xAxisLabelFontSize: ((_h = config$1.quadrantChart) === null || _h === void 0 ? void 0 : _h.xAxisLabelFontSize) || 16,
      yAxisLabelFontSize: ((_j = config$1.quadrantChart) === null || _j === void 0 ? void 0 : _j.yAxisLabelFontSize) || 16,
      quadrantLabelFontSize: ((_k = config$1.quadrantChart) === null || _k === void 0 ? void 0 : _k.quadrantLabelFontSize) || 16,
      quadrantTextTopPadding: ((_l = config$1.quadrantChart) === null || _l === void 0 ? void 0 : _l.quadrantTextTopPadding) || 5,
      pointTextPadding: ((_m = config$1.quadrantChart) === null || _m === void 0 ? void 0 : _m.pointTextPadding) || 5,
      pointLabelFontSize: ((_o = config$1.quadrantChart) === null || _o === void 0 ? void 0 : _o.pointLabelFontSize) || 12,
      pointRadius: ((_p = config$1.quadrantChart) === null || _p === void 0 ? void 0 : _p.pointRadius) || 5,
      xAxisPosition: ((_q = config$1.quadrantChart) === null || _q === void 0 ? void 0 : _q.xAxisPosition) || "top",
      yAxisPosition: ((_r = config$1.quadrantChart) === null || _r === void 0 ? void 0 : _r.yAxisPosition) || "left",
      quadrantInternalBorderStrokeWidth: ((_s = config$1.quadrantChart) === null || _s === void 0 ? void 0 : _s.quadrantInternalBorderStrokeWidth) || 1,
      quadrantExternalBorderStrokeWidth: ((_t = config$1.quadrantChart) === null || _t === void 0 ? void 0 : _t.quadrantExternalBorderStrokeWidth) || 2
    };
  }
  ...
  getQuadrantPoints(spaceData) {
    ...
    const points = this.data.points.map((point) => {
      ...
      const props = {
        x: xAxis(point.x),
        y: yAxis(point.y),
        fill: (_a = point.color) !== null && _a !== void 0 ? _a : this.themeConfig.quadrantPointFill,
        radius: (_b = point.radius) !== null && _b !== void 0 ? _b : this.config.pointRadius,
        text: {
          text: point.text,
        ...
        strokeColor: (_c = point.strokeColor) !== null && _c !== void 0 ? _c : this.themeConfig.quadrantPointFill,
        strokeWidth: (_d = point.strokeWidth) !== null && _d !== void 0 ? _d : "0px"
      };
      return props;
    });
    return points;
...
const draw = (txt, id, _version, diagObj) => {
  ...
  const width = (_b = (_a = conf.quadrantChart) === null || _a === void 0 ? void 0 : _a.chartWidth) !== null && _b !== void 0 ? _b : 500;
  const height = (_d = (_c = conf.quadrantChart) === null || _c === void 0 ? void 0 : _c.chartHeight) !== null && _d !== void 0 ? _d : 500;
  configureSvgSize(svg, height, width, (_f = (_e = conf.quadrantChart) === null || _e === void 0 ? void 0 : _e.useMaxWidth) !== null && _f !== void 0 ? _f : true);
