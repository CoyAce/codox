import { q as setAccTitle, o as getAccTitle, m as setAccDescription, n as getAccDescription, C as setDiagramTitle, D as getDiagramTitle, g as getConfig, l as log, I as clear, L as getRegisteredLayoutAlgorithm, M as render, H as utils } from "./mermaid-DiDd0-cy.js";
import { g as getDiagramElement, s as setupViewPortForSVG } from "./setupViewPortForSVG-B_KX14WS.js";
var parser = function() {
  var o = function(k, v, o2, l) {
    for (o2 = o2 || {}, l = k.length; l--; o2[k[l]] = v) ;
    return o2;
  }, $V0 = [1, 3], $V1 = [1, 4], $V2 = [1, 5], $V3 = [1, 6], $V4 = [5, 6, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], $V5 = [1, 22], $V6 = [2, 7], $V7 = [1, 26], $V8 = [1, 27], $V9 = [1, 28], $Va = [1, 29], $Vb = [1, 33], $Vc = [1, 34], $Vd = [1, 35], $Ve = [1, 36], $Vf = [1, 37], $Vg = [1, 38], $Vh = [1, 24], $Vi = [1, 31], $Vj = [1, 32], $Vk = [1, 30], $Vl = [1, 39], $Vm = [1, 40], $Vn = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], $Vo = [1, 61], $Vp = [89, 90], $Vq = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 29, 41, 42, 43, 44, 45, 46, 54, 61, 63, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], $Vr = [27, 29], $Vs = [1, 70], $Vt = [1, 71], $Vu = [1, 72], $Vv = [1, 73], $Vw = [1, 74], $Vx = [1, 75], $Vy = [1, 76], $Vz = [1, 83], $VA = [1, 80], $VB = [1, 84], $VC = [1, 85], $VD = [1, 86], $VE = [1, 87], $VF = [1, 88], $VG = [1, 89], $VH = [1, 90], $VI = [1, 91], $VJ = [1, 92], $VK = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], $VL = [63, 64], $VM = [1, 101], $VN = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 76, 77, 89, 90], $VO = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], $VP = [1, 110], $VQ = [1, 106], $VR = [1, 107], $VS = [1, 108], $VT = [1, 109], $VU = [1, 111], $VV = [1, 116], $VW = [1, 117], $VX = [1, 114], $VY = [1, 115];
  var parser2 = {
...
class RequirementDB {
  constructor() {
    ...
    this.getConfig = () => getConfig().requirement;
    this.clear();
  ...
  setCssStyle(ids, styles) {
    var _a;
    for (const id of ids) {
      const node = (_a = this.requirements.get(id)) !== null && _a !== void 0 ? _a : this.elements.get(id);
      if (!styles || !node) {
        return;
      }
    ...
    for (const id of ids) {
      ...
      if (node) {
        for (const _class of classNames) {
          ...
          const styles = (_b = this.classes.get(_class)) === null || _b === void 0 ? void 0 : _b.styles;
          if (styles) {
  ...
  getData() {
    ...
    for (const relation of this.relations) {
      ...
      const edge = {
        ...
        start: (_b = (_a = this.requirements.get(relation.src)) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : (_c = this.elements.get(relation.src)) === null || _c === void 0 ? void 0 : _c.name,
        end: (_e = (_d = this.requirements.get(relation.dst)) === null || _d === void 0 ? void 0 : _d.name) !== null && _e !== void 0 ? _e : (_f = this.elements.get(relation.dst)) === null || _f === void 0 ? void 0 : _f.name,
        label: `&lt;&lt;${relation.type}&gt;&gt;`,
...
const draw = async function(text, id, _version, diag) {
  ...
  data4Layout.nodeSpacing = (_a = conf === null || conf === void 0 ? void 0 : conf.nodeSpacing) !== null && _a !== void 0 ? _a : 50;
  data4Layout.rankSpacing = (_b = conf === null || conf === void 0 ? void 0 : conf.rankSpacing) !== null && _b !== void 0 ? _b : 50;
  data4Layout.markers = ["requirement_contains", "requirement_arrow"];
  data4Layout.diagramId = id;
  await render(data4Layout, svg);
  const padding = 8;
  utils.insertTitle(svg, "requirementDiagramTitleText", (_c = conf === null || conf === void 0 ? void 0 : conf.titleTopMargin) !== null && _c !== void 0 ? _c : 25, diag.db.getDiagramTitle());
  setupViewPortForSVG(svg, padding, "requirementDiagram", (_d = conf === null || conf === void 0 ? void 0 : conf.useMaxWidth) !== null && _d !== void 0 ? _d : true);
};
