import { q as setAccTitle, o as getAccTitle, m as setAccDescription, n as getAccDescription, C as setDiagramTitle, D as getDiagramTitle, g as getConfig, l as log, I as clear, G as getEdgeId, L as getRegisteredLayoutAlgorithm, M as render, w as select, H as utils, N as rgba } from "./mermaid-DiDd0-cy.js";
...
var parser = function() {
  var o = function(k, v, o2, l) {
    ...
    return o2;
  }, $V0 = [6, 8, 10, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 50], $V1 = [1, 10], $V2 = [1, 11], $V3 = [1, 12], $V4 = [1, 13], $V5 = [1, 20], $V6 = [1, 21], $V7 = [1, 22], $V8 = [1, 23], $V9 = [1, 24], $Va = [1, 19], $Vb = [1, 25], $Vc = [1, 26], $Vd = [1, 18], $Ve = [1, 33], $Vf = [1, 34], $Vg = [1, 35], $Vh = [1, 36], $Vi = [1, 37], $Vj = [6, 8, 10, 13, 15, 17, 20, 21, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 50, 63, 64, 65, 66, 67], $Vk = [1, 42], $Vl = [1, 43], $Vm = [1, 52], $Vn = [40, 50, 68, 69], $Vo = [1, 63], $Vp = [1, 61], $Vq = [1, 58], $Vr = [1, 62], $Vs = [1, 64], $Vt = [6, 8, 10, 13, 17, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 41, 42, 43, 44, 48, 49, 50, 63, 64, 65, 66, 67], $Vu = [63, 64, 65, 66, 67], $Vv = [1, 81], $Vw = [1, 80], $Vx = [1, 78], $Vy = [1, 79], $Vz = [6, 10, 42, 47], $VA = [6, 10, 13, 41, 42, 47, 48, 49], $VB = [1, 89], $VC = [1, 88], $VD = [1, 87], $VE = [19, 56], $VF = [1, 98], $VG = [1, 97], $VH = [19, 56, 58, 60];
  var parser2 = {
  ...
  addEntity(name, alias = "") {
    ...
    if (!this.entities.has(name)) {
      this.entities.set(name, {
        ...
        alias,
        shape: "erBox",
        look: (_a = getConfig().look) !== null && _a !== void 0 ? _a : "default",
        cssClasses: "default",
        cssStyles: []
      });
      log.info("Added new entity :", name);
    } else if (!((_b = this.entities.get(name)) === null || _b === void 0 ? void 0 : _b.alias) && alias) {
...
const draw = async function(text, id, _version, diag) {
  ...
  const padding = 8;
  utils.insertTitle(svg, "erDiagramTitleText", (_a = conf === null || conf === void 0 ? void 0 : conf.titleTopMargin) !== null && _a !== void 0 ? _a : 25, diag.db.getDiagramTitle());
  setupViewPortForSVG(svg, padding, "erDiagram", (_b = conf === null || conf === void 0 ? void 0 : conf.useMaxWidth) !== null && _b !== void 0 ? _b : true);
};
