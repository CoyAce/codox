import { q as setAccTitle, m as setAccDescription, C as setDiagramTitle, o as getAccTitle, n as getAccDescription, D as getDiagramTitle, g as getConfig, I as clear, l as log, r as sanitizeText, t as distExports, af as hasKatex, v as common, a6 as parseFontSize, ag as ZERO_WIDTH_SPACE, ah as renderKatex, Q as getConfig$1, ai as calculateMathMLDimensions, w as select, x as configureSvgSize, y as assignWithDepth, H as utils, O as setConfig } from "./mermaid-BTN5MP6C.js";
import { I as ImperativeState } from "./imperativeState-CzGTFSDU.js";
import { a as drawBackgroundRect$1, b as getTextObj$1, d as drawRect$1, g as getNoteRect$1, c as drawEmbeddedImage, e as drawImage } from "./svgDrawCommon-UGd__fip.js";
var parser = function() {
  var o = function(k, v, o2, l) {
    for (o2 = o2 || {}, l = k.length; l--; o2[k[l]] = v) ;
    return o2;
  }, $V0 = [1, 2], $V1 = [1, 3], $V2 = [1, 4], $V3 = [2, 4], $V4 = [1, 9], $V5 = [1, 11], $V6 = [1, 13], $V7 = [1, 14], $V8 = [1, 16], $V9 = [1, 17], $Va = [1, 18], $Vb = [1, 24], $Vc = [1, 25], $Vd = [1, 26], $Ve = [1, 27], $Vf = [1, 28], $Vg = [1, 29], $Vh = [1, 30], $Vi = [1, 31], $Vj = [1, 32], $Vk = [1, 33], $Vl = [1, 34], $Vm = [1, 35], $Vn = [1, 36], $Vo = [1, 37], $Vp = [1, 38], $Vq = [1, 39], $Vr = [1, 41], $Vs = [1, 42], $Vt = [1, 43], $Vu = [1, 44], $Vv = [1, 45], $Vw = [1, 46], $Vx = [1, 4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 48, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], $Vy = [4, 5, 16, 50, 52, 53], $Vz = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 50, 52, 53, 54, 59, 60, 61, 62, 70], $VA = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], $VB = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 48, 50, 52, 53, 54, 59, 60, 61, 62, 70], $VC = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 50, 52, 53, 54, 59, 60, 61, 62, 70], $VD = [68, 69, 70], $VE = [1, 122];
  var parser2 = {
...
class SequenceDB {
  ...
  addActor(id, name, description, type) {
    ...
    this.state.records.actors.set(id, {
      ...
      wrap: (_a = description.wrap) !== null && _a !== void 0 ? _a : this.autoWrap(),
  ...
  addMessage(idFrom, idTo, message, answer) {
    ...
    this.state.records.messages.push({
      ...
      wrap: (_a = message.wrap) !== null && _a !== void 0 ? _a : this.autoWrap(),
      answer
    });
  }
  addSignal(idFrom, idTo, message, messageType, activate = false) {
    ...
    this.state.records.messages.push({
      ...
      from: idFrom,
      to: idTo,
      message: (_a = message === null || message === void 0 ? void 0 : message.text) !== null && _a !== void 0 ? _a : "",
      wrap: (_b = message === null || message === void 0 ? void 0 : message.wrap) !== null && _b !== void 0 ? _b : this.autoWrap(),
      type: messageType,
      activate
    });
    return true;
  ...
  autoWrap() {
    ...
    return (_b = (_a = getConfig().sequence) === null || _a === void 0 ? void 0 : _a.wrap) !== null && _b !== void 0 ? _b : false;
  }
  clear() {
    this.state.reset();
    clear();
  ...
  parseBoxData(str) {
    ...
    return {
      text: cleanedText ? sanitizeText(cleanedText, getConfig()) : void 0,
      color,
      wrap
    };
  }
  addNote(actor, placement, message) {
    ...
    this.state.records.messages.push({
      ...
      to: actors[1],
      message: message.text,
      wrap: (_b = message.wrap) !== null && _b !== void 0 ? _b : this.autoWrap(),
...
const drawMessage = async function(diagram2, msgModel, lineStartY, diagObj) {
  ...
  if (startx === stopx) {
    if (conf.rightAngles) {
      line = diagram2.append("path").attr("d", `M  ${startx},${lineStartY} H ${startx + common.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`);
    } else {
...
const draw = async function(_text, id, _version, diagObj) {
  ...
  addActorRenderingData(diagram2, actors, createdActors, actorKeys, 0);
  ...
  function activeEnd(msg, verticalPos) {
    ...
    svgDraw.drawActivation(diagram2, activationData, verticalPos, conf, actorActivations(msg.from).length);
...
const buildNoteModel = async function(msg, actors, diagObj) {
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? common.getMax(conf.width, textDimensions.width) : common.getMax(fromActor.width / 2 + toActor.width / 2, textDimensions.width + 2 * conf.noteMargin);
    noteModel.startx = startx + (fromActor.width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? common.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : common.getMax(fromActor.width / 2 + toActor.width / 2, textDimensions.width + 2 * conf.noteMargin);
    noteModel.startx = startx - noteModel.width + (fromActor.width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = utils.calculateTextDimensions(shouldWrap ? utils.wrapLabel(msg.message, common.getMax(conf.width, fromActor.width), noteFont(conf)) : msg.message, noteFont(conf));
    noteModel.width = shouldWrap ? common.getMax(conf.width, fromActor.width) : common.getMax(fromActor.width, conf.width, textDimensions.width + 2 * conf.noteMargin);
