import { C as setDiagramTitle, D as getDiagramTitle, m as setAccDescription, n as getAccDescription, q as setAccTitle, o as getAccTitle, g as getConfig, I as clear$1, v as common, K as defaultConfig, w as select, aF as setupGraphViewbox } from "./mermaid-BTN5MP6C.js";
...
const draw = function(text, id, _version, diagObj) {
  ...
  const width = (_a = conf === null || conf === void 0 ? void 0 : conf.width) !== null && _a !== void 0 ? _a : defaultSankeyConfig.width;
  const height = (_b = conf === null || conf === void 0 ? void 0 : conf.height) !== null && _b !== void 0 ? _b : defaultSankeyConfig.width;
  const useMaxWidth = (_c = conf === null || conf === void 0 ? void 0 : conf.useMaxWidth) !== null && _c !== void 0 ? _c : defaultSankeyConfig.useMaxWidth;
  const nodeAlignment = (_d = conf === null || conf === void 0 ? void 0 : conf.nodeAlignment) !== null && _d !== void 0 ? _d : defaultSankeyConfig.nodeAlignment;
  const prefix = (_e = conf === null || conf === void 0 ? void 0 : conf.prefix) !== null && _e !== void 0 ? _e : defaultSankeyConfig.prefix;
  const suffix = (_f = conf === null || conf === void 0 ? void 0 : conf.suffix) !== null && _f !== void 0 ? _f : defaultSankeyConfig.suffix;
  const showValues = (_g = conf === null || conf === void 0 ? void 0 : conf.showValues) !== null && _g !== void 0 ? _g : defaultSankeyConfig.showValues;
...
${prefix}${Math.round(value2 * 100) / 100}${suffix}`;
  ...
  const linkColor = (_h = conf === null || conf === void 0 ? void 0 : conf.linkColor) !== null && _h !== void 0 ? _h : "gradient";
...
parser.parse = (text) => originalParse(prepareTextForParsing(text));
const diagram = {
  styles: getStyles,
  parser,
  db,
