import { c as clone } from "./clone-_10PAmr7.js";
import { Q as getConfig, l as log, I as clear$1, v as common, g as getConfig$1, N as rgba, aX as evaluate, aY as replaceIconSubstring, aZ as decodeEntities, w as select, a9 as line, a_ as getLineFunctionsWithOffset, ak as curveBasis, aW as createText, e as getSubGraphTitleMargins, H as utils, r as sanitizeText$1, a$ as getStylesFromArray, x as configureSvgSize } from "./mermaid-BTN5MP6C.js";
import { g as getIconStyles } from "./globalStyles-UCF2HUCK.js";
import { c as channel } from "./channel-CK9nrhp0.js";
import { G as Graph } from "./graph-B9mYqs7A.js";
var parser = function() {
...
function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
  ...
  log.debug("setBlockSizes abc95 (start)", block.id, (_a2 = block === null || block === void 0 ? void 0 : block.size) === null || _a2 === void 0 ? void 0 : _a2.x, "block width =", block === null || block === void 0 ? void 0 : block.size, "siblingWidth", siblingWidth);
...
const class_box = async (parent, node) => {
  ...
  const interfaceLabel = labelContainer.node().appendChild(await createLabel(interfaceLabelText, node.labelStyle, true, true));
  ...
  const classTitleLabel = labelContainer.node().appendChild(await createLabel(classTitleString, node.labelStyle, true, true));
