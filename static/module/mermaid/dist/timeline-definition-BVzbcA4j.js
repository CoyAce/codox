import { aE as commonDb, I as clear$1, w as select, g as getConfig, l as log, aF as setupGraphViewbox, aG as isDark, aH as lighten, aI as darken } from "./mermaid-BTN5MP6C.js";
...
const draw = function(text, id, version, diagObj) {
  ...
  const LEFT_MARGIN = (_a = conf.leftMargin) !== null && _a !== void 0 ? _a : 50;
  ...
  setupGraphViewbox(void 0, svg, (_c = (_b = conf.timeline) === null || _b === void 0 ? void 0 : _b.padding) !== null && _c !== void 0 ? _c : 50, (_e = (_d = conf.timeline) === null || _d === void 0 ? void 0 : _d.useMaxWidth) !== null && _e !== void 0 ? _e : false);
};
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  ...
  for (const task of tasks2) {
    ...
    masterX = masterX + 200;
    if (isWithoutSections && !((_a = conf.timeline) === null || _a === void 0 ? void 0 : _a.disableMulticolor)) {
      sectionColor++;
    }
  }
  masterY = masterY - 10;
