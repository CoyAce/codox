import{a as H}from"./chunk-2PTL725G.mjs";import{a as Z}from"./chunk-TCZ2FQIQ.mjs";import"./chunk-VC7APOFF.mjs";import"./chunk-UVFIN2MV.mjs";import"./chunk-TJYKWGKR.mjs";import"./chunk-QPOOX5NZ.mjs";import{a as J}from"./chunk-NTNTV3YI.mjs";import{k as V,l as U}from"./chunk-KIEMEOLO.mjs";import"./chunk-XE64DKBQ.mjs";import{Ba as C,Ea as N,M as O,P as j,Q as _,R as z,S as B,T as M,U as W,V as I,X as L,b as m,ia as q,s as F}from"./chunk-LXRGKPZR.mjs";import"./chunk-Q2D2FR5V.mjs";import"./chunk-DR5ZIJPQ.mjs";import"./chunk-F7RMZNIO.mjs";import"./chunk-TI3GW6ZA.mjs";import"./chunk-LVHBRLQJ.mjs";import"./chunk-YLAFDWD2.mjs";import{a as t}from"./chunk-CPXVQKWD.mjs";var K=F.pie,A={sections:new Map,showData:!1,config:K},u=A.sections,w=A.showData,ce=structuredClone(K),pe=t(()=>structuredClone(ce),"getConfig"),me=t(()=>{u=new Map,w=A.showData,j()},"clear"),le=t(({label:e,value:i})=>{u.has(e)||(u.set(e,i),m.debug(`added new section: ${e}, with value: ${i}`))},"addSection"),de=t(()=>u,"getSections"),fe=t(e=>{w=e},"setShowData"),ge=t(()=>w,"getShowData"),S={getConfig:pe,clear:me,setDiagramTitle:W,getDiagramTitle:I,setAccTitle:_,getAccTitle:z,setAccDescription:B,getAccDescription:M,addSection:le,getSections:de,setShowData:fe,getShowData:ge};var De=t((e,i)=>{H(e,i),i.setShowData(e.showData),e.sections.map(i.addSection)},"populateDb"),Q={parse:t(async e=>{let i=await Z("pie",e);m.debug(i),De(i,S)},"parse")};var ue=t(e=>`
  .pieCircle{
