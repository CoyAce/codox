import { l as log, g as getConfig, r as sanitizeText, R as config, $ as getDefaultExportFromCjs, aW as createText, a6 as parseFontSize, a2 as selectSvgElement, aF as setupGraphViewbox, w as select, aG as isDark, aH as lighten, aI as darken } from "./mermaid-BTN5MP6C.js";
...
const decorateNode = (decoration) => {
  ...
  if (decoration.class) {
    node.class = sanitizeText(decoration.class, config2);
  }
};
const type2Str = (type) => {
  switch (type) {
...
const drawNode = async function(db2, elem, node, fullSection, conf) {
...
const draw = async (text, id, _version, diagObj) => {
  ...
  setupGraphViewbox(void 0, svg, (_b = (_a = conf.mindmap) === null || _a === void 0 ? void 0 : _a.padding) !== null && _b !== void 0 ? _b : config.mindmap.padding, (_d = (_c = conf.mindmap) === null || _c === void 0 ? void 0 : _c.useMaxWidth) !== null && _d !== void 0 ? _d : config.mindmap.useMaxWidth);
};
const renderer = {
  draw
};
