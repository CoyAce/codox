import { l as log, g as getConfig, r as sanitizeText, R as config, E as load, J as JSON_SCHEMA, a2 as selectSvgElement, f as insertCluster, d as insertNode, p as positionNode, aF as setupGraphViewbox, aG as isDark, aH as lighten, aI as darken } from "./mermaid-BTN5MP6C.js";
import { g as getIconStyles } from "./globalStyles-UCF2HUCK.js";
var parser = function() {
  var o = function(k, v, o2, l) {
    for (o2 = o2 || {}, l = k.length; l--; o2[k[l]] = v) ;
    return o2;
  }, $V0 = [1, 4], $V1 = [1, 13], $V2 = [1, 12], $V3 = [1, 15], $V4 = [1, 16], $V5 = [1, 20], $V6 = [1, 19], $V7 = [6, 7, 8], $V8 = [1, 26], $V9 = [1, 24], $Va = [1, 25], $Vb = [6, 7, 11], $Vc = [1, 31], $Vd = [6, 7, 11, 24], $Ve = [1, 6, 13, 16, 17, 20, 23], $Vf = [1, 35], $Vg = [1, 36], $Vh = [1, 6, 7, 11, 13, 16, 17, 20, 23], $Vi = [1, 38];
  var parser2 = {
...
const getData = function() {
  ...
  for (const section of sections2) {
    const node = {
      id: section.id,
      label: sanitizeText((_a = section.label) !== null && _a !== void 0 ? _a : "", conf),
      isGroup: true,
    ...
    for (const item of children) {
      const childNode = {
        id: item.id,
        parentId: section.id,
        label: sanitizeText((_b = item.label) !== null && _b !== void 0 ? _b : "", conf),
        isGroup: false,
...
const addNode = (level, id, descr, type, shapeData) => {
  var _a, _b, _c, _d;
  const conf = getConfig();
  let padding = (_b = (_a = conf.mindmap) === null || _a === void 0 ? void 0 : _a.padding) !== null && _b !== void 0 ? _b : config.mindmap.padding;
  switch (type) {
  ...
  const node = {
    ...
    width: (_d = (_c = conf.mindmap) === null || _c === void 0 ? void 0 : _c.maxNodeWidth) !== null && _d !== void 0 ? _d : config.mindmap.maxNodeWidth,
    padding,
    isGroup: false
  };
  if (shapeData !== void 0) {
...
const decorateNode = (decoration) => {
  ...
  if (decoration.icon) {
    node.icon = sanitizeText(decoration.icon, config2);
  }
  if (decoration.class) {
    node.cssClasses = sanitizeText(decoration.class, config2);
  }
};
const type2Str = (type) => {
  switch (type) {
...
const draw = async (text, id, _version, diagObj) => {
  ...
  for (const section of sections2) {
    const WIDTH = ((_a = conf === null || conf === void 0 ? void 0 : conf.kanban) === null || _a === void 0 ? void 0 : _a.sectionWidth) || 200;
    cnt2 = cnt2 + 1;
    ...
    maxLabelHeight = Math.max(maxLabelHeight, (_b = sectionObj === null || sectionObj === void 0 ? void 0 : sectionObj.labelBBox) === null || _b === void 0 ? void 0 : _b.height);
  ...
  for (const section of sections2) {
    ...
    i = i + 1;
    const WIDTH = ((_c = conf === null || conf === void 0 ? void 0 : conf.kanban) === null || _c === void 0 ? void 0 : _c.sectionWidth) || 200;
  ...
  setupGraphViewbox(void 0, svg, (_e = (_d = conf.mindmap) === null || _d === void 0 ? void 0 : _d.padding) !== null && _e !== void 0 ? _e : config.kanban.padding, (_g = (_f = conf.mindmap) === null || _f === void 0 ? void 0 : _f.useMaxWidth) !== null && _g !== void 0 ? _g : config.kanban.useMaxWidth);
};
const renderer = {
  draw
};
const genSections = (options) => {
  ...
  const adjuster = (color, level) => options.darkMode ? darken(color, level) : lighten(color, level);
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw = "" + (17 - 3 * i);
    sections2 += `
