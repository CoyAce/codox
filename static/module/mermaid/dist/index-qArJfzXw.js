import { i as isUndefined, G as Graph } from "./graph-C-cCm_RP.js";
import { m as map, l as layout } from "./layout-4jbSGgyB.js";
import { c as clone } from "./clone-D_txxdpQ.js";
import { l as log, i as insertMarkers, c as clear$1, a as clear$2, b as clear$3, g as getConfig, u as updateNodeBounds, s as setNodeElem, d as insertNode, e as getSubGraphTitleMargins, p as positionNode, f as insertCluster, h as insertEdge, j as positionEdgeLabel, k as insertEdgeLabel } from "./mermaid-DiDd0-cy.js";
function write(g) {
  var json = {
    options: {
...
let clusterDb = /* @__PURE__ */ new Map();
let descendants = /* @__PURE__ */ new Map();
...
const findNonClusterChild = (id, graph, clusterId) => {
  const children = graph.children(id);
...
const render = async (data4Layout, svg) => {
