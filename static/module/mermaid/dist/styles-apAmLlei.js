import { g as getConfig, l as log, v as common, M as render, H as utils, o as getAccTitle, q as setAccTitle, n as getAccDescription, m as setAccDescription, C as setDiagramTitle, D as getDiagramTitle, aC as generateId, I as clear } from "./mermaid-BTN5MP6C.js";
import { g as getDiagramElement, s as setupViewPortForSVG } from "./setupViewPortForSVG-qnbm0tT-.js";
var parser = function() {
  var o = function(k, v, o2, l) {
    for (o2 = o2 || {}, l = k.length; l--; o2[k[l]] = v) ;
    return o2;
  }, $V0 = [1, 2], $V1 = [1, 3], $V2 = [1, 4], $V3 = [2, 4], $V4 = [1, 9], $V5 = [1, 11], $V6 = [1, 16], $V7 = [1, 17], $V8 = [1, 18], $V9 = [1, 19], $Va = [1, 32], $Vb = [1, 20], $Vc = [1, 21], $Vd = [1, 22], $Ve = [1, 23], $Vf = [1, 24], $Vg = [1, 26], $Vh = [1, 27], $Vi = [1, 28], $Vj = [1, 29], $Vk = [1, 30], $Vl = [1, 31], $Vm = [1, 34], $Vn = [1, 35], $Vo = [1, 36], $Vp = [1, 37], $Vq = [1, 33], $Vr = [1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], $Vs = [1, 4, 5, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], $Vt = [4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54];
  var parser2 = {
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: common.sanitizeText((_a = item.description) !== null && _a !== void 0 ? _a : "", getConfig()),
...
const getDir$1 = (parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
function insertOrUpdateNode(nodes, nodeData, classes) {
  ...
  if (nodeData.cssClasses) {
    ...
    nodeData.cssClasses.split(" ").forEach((cssClass) => {
      ...
      if (classDef) {
        nodeData.cssCompiledStyles = [...(_a = nodeData.cssCompiledStyles) !== null && _a !== void 0 ? _a : [], ...classDef.styles];
      }
    });
  }
...
function getClassesFromDbInfo(dbInfoItem) {
  var _a, _b;
  return (_b = (_a = dbInfoItem === null || dbInfoItem === void 0 ? void 0 : dbInfoItem.classes) === null || _a === void 0 ? void 0 : _a.join(" ")) !== null && _b !== void 0 ? _b : "";
}
function getStylesFromDbInfo(dbInfoItem) {
  var _a;
  return (_a = dbInfoItem === null || dbInfoItem === void 0 ? void 0 : dbInfoItem.styles) !== null && _a !== void 0 ? _a : [];
}
const dataFetcher = (parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  var _a, _b, _c;
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.description) {
      if (Array.isArray(newNode.description)) {
        ...
        if (((_a = newNode.description) === null || _a === void 0 ? void 0 : _a.length) && newNode.description.length > 0) {
          newNode.shape = SHAPE_STATE_WITH_DESC;
    ...
    if (((_b = newNode.description) === null || _b === void 0 ? void 0 : _b.length) === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
    ...
    if (!newNode.type && parsedItem.doc) {
      log.info("Setting cluster for XCX", itemId, getDir$1(parsedItem));
      newNode.type = "group";
      newNode.isGroup = true;
      newNode.dir = getDir$1(parsedItem);
    ...
    if (parsedItem.note) {
      const noteData = {
        ...
        type: newNode.type,
        isGroup: newNode.type === "group",
        padding: (_c = config.flowchart) === null || _c === void 0 ? void 0 : _c.padding,
        look,
...
const draw = async function(text, id, _version, diag) {
  ...
  const padding = 8;
  utils.insertTitle(svg, "statediagramTitleText", (_a = conf === null || conf === void 0 ? void 0 : conf.titleTopMargin) !== null && _a !== void 0 ? _a : 25, diag.db.getDiagramTitle());
  setupViewPortForSVG(svg, padding, CSS_DIAGRAM, (_b = conf === null || conf === void 0 ? void 0 : conf.useMaxWidth) !== null && _b !== void 0 ? _b : true);
};
const renderer = {
  getClasses,
  draw,
...
const newClassesList = () => /* @__PURE__ */ new Map();
const newDoc = () => ({
  relations: [],
...
class StateDB {
    ...
    for (const id of ids) {
      ...
      if (state) {
        state.styles = styles.map((s) => {
          var _a;
          return (_a = s.replace(/;/g, "")) === null || _a === void 0 ? void 0 : _a.trim();
        });
      }
    }
  }
  ...
  addRelation(item1, item2, title) {
    if (typeof item1 === "object" && typeof item2 === "object") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        relationTitle: title ? common.sanitizeText(title, getConfig()) : void 0
      });
    }
  }
  addDescription(id, descr) {
    ...
    (_a = theState === null || theState === void 0 ? void 0 : theState.descriptions) === null || _a === void 0 ? void 0 : _a.push(common.sanitizeText(_descr, getConfig()));
  }
  cleanupLabel(label) {
  ...
  setCssClass(itemIds, cssClassName) {
    itemIds.split(",").forEach((id) => {
      ...
      (_a = foundState === null || foundState === void 0 ? void 0 : foundState.classes) === null || _a === void 0 ? void 0 : _a.push(cssClassName);
    });
  }
  /**
  ...
  setStyle(itemId, styleText) {
    var _a, _b;
    (_b = (_a = this.getState(itemId)) === null || _a === void 0 ? void 0 : _a.styles) === null || _b === void 0 ? void 0 : _b.push(styleText);
  }
  /**
  ...
  setTextStyle(itemId, cssClassName) {
    var _a, _b;
    (_b = (_a = this.getState(itemId)) === null || _a === void 0 ? void 0 : _a.textStyles) === null || _b === void 0 ? void 0 : _b.push(cssClassName);
  }
  /**
  ...
  getDirection() {
    var _a, _b;
    return (_b = (_a = this.getDirectionStatement()) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : DEFAULT_DIAGRAM_DIRECTION;
  }
  setDirection(dir) {
