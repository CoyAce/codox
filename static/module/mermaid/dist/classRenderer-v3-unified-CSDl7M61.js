import { r as sanitizeText$1, g as getConfig, aj as parseGenericTypes, w as select, q as setAccTitle, o as getAccTitle, m as setAccDescription, n as getAccDescription, C as setDiagramTitle, D as getDiagramTitle, v as common, I as clear, l as log, H as utils, G as getEdgeId, L as getRegisteredLayoutAlgorithm, M as render } from "./mermaid-BTN5MP6C.js";
...
class ClassDB {
  ...
  addRelation(classRelation) {
    ...
    classRelation.relationTitle1 = common.sanitizeText(classRelation.relationTitle1.trim(), getConfig());
    classRelation.relationTitle2 = common.sanitizeText(classRelation.relationTitle2.trim(), getConfig());
  ...
  getData() {
    ...
    for (const namespaceKey of this.namespaces.keys()) {
      ...
      if (namespace) {
        const node = {
          ...
          label: namespace.id,
          isGroup: true,
          padding: (_a = config.class.padding) !== null && _a !== void 0 ? _a : 16,
    ...
    for (const note of this.notes) {
      ...
      nodes.push(noteNode);
      const noteClassId = (_d = (_c = this.classes.get(note.class)) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : "";
      if (noteClassId) {
        const edge = {
          id: `edgeNote${cnt}`,
          start: note.id,
...
.classTitleText {
  ...
  ${getIconStyles()}
`;
const getDir = (parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
const draw = async function(text, id, _version, diag) {
  ...
  const padding = 8;
  utils.insertTitle(svg, "classDiagramTitleText", (_a = conf === null || conf === void 0 ? void 0 : conf.titleTopMargin) !== null && _a !== void 0 ? _a : 25, diag.db.getDiagramTitle());
  setupViewPortForSVG(svg, padding, "classDiagram", (_b = conf === null || conf === void 0 ? void 0 : conf.useMaxWidth) !== null && _b !== void 0 ? _b : true);
};
const renderer = {
  getClasses,
  draw,
