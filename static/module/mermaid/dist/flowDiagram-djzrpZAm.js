import { g as getConfig, q as setAccTitle, m as setAccDescription, C as setDiagramTitle, o as getAccTitle, n as getAccDescription, D as getDiagramTitle, v as common, E as load, J as JSON_SCHEMA, F as isValidShape, l as log, G as getEdgeId, H as utils, w as select, I as clear, K as defaultConfig, L as getRegisteredLayoutAlgorithm, M as render, N as rgba, O as setConfig } from "./mermaid-BTN5MP6C.js";
...
class FlowDB {
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (doc !== void 0) {
      ...
      if (doc === null || doc === void 0 ? void 0 : doc.icon) {
        ...
        if (!((_a = doc.label) === null || _a === void 0 ? void 0 : _a.trim()) && vertex.text === id) {
          vertex.text = "";
        }
      }
      ...
      if (doc === null || doc === void 0 ? void 0 : doc.img) {
        ...
        if (!((_b = doc.label) === null || _b === void 0 ? void 0 : _b.trim()) && vertex.text === id) {
          vertex.text = "";
        }
      }
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    if (this.edges.length < ((_a = this.config.maxEdges) !== null && _a !== void 0 ? _a : 500)) {
...
You have to call mermaid.initialize.`);
  ...
  updateLink(positions, style) {
    positions.forEach((pos) => {
      ...
      if (pos === "default") {
        ...
        if (((_c = (_b = (_a = this.edges[pos]) === null || _a === void 0 ? void 0 : _a.style) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0) > 0 && !((_e = (_d = this.edges[pos]) === null || _d === void 0 ? void 0 : _d.style) === null || _e === void 0 ? void 0 : _e.some((s) => s === null || s === void 0 ? void 0 : s.startsWith("fill")))) {
          (_g = (_f = this.edges[pos]) === null || _f === void 0 ? void 0 : _f.style) === null || _g === void 0 ? void 0 : _g.push("fill:none");
        }
      }
    });
  }
  ...
  setupToolTips(element) {
    ...
    nodes.on("mouseover", (e) => {
      ...
      const rect = (_a = e.currentTarget) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect();
  ...
  addNodeFromVertex(vertex, nodes, parentDB, subGraphDB, config, look) {
    ...
    const isGroup = (_a = subGraphDB.get(vertex.id)) !== null && _a !== void 0 ? _a : false;
    ...
    if (node) {
      ...
      const baseNode = {
        ...
        labelStyle: "",
        parentId,
        padding: ((_b = config.flowchart) === null || _b === void 0 ? void 0 : _b.padding) || 8,
  ...
  getCompiledStyles(classDefs) {
    ...
    for (const customClass of classDefs) {
      ...
      if (cssClass === null || cssClass === void 0 ? void 0 : cssClass.styles) {
        compiledStyles = [...compiledStyles, ...(_a = cssClass.styles) !== null && _a !== void 0 ? _a : []].map((s) => s.trim());
      }
      if (cssClass === null || cssClass === void 0 ? void 0 : cssClass.textStyles) {
        compiledStyles = [...compiledStyles, ...(_b = cssClass.textStyles) !== null && _b !== void 0 ? _b : []].map((s) => s.trim());
      }
    }
  ...
  getData() {
    ...
    e.forEach((rawEdge, index) => {
      ...
      const styles = [...(_a = e.defaultStyle) !== null && _a !== void 0 ? _a : []];
      if (rawEdge.style) {
      ...
      const edge = {
        ...
        curve: rawEdge.interpolate || this.edges.defaultInterpolate || ((_c = config.flowchart) === null || _c === void 0 ? void 0 : _c.curve)
      };
      edges.push(edge);
    });
...
const draw = async function(text, id, _version, diag) {
  ...
  const padding = (_b = (_a = data4Layout.config.flowchart) === null || _a === void 0 ? void 0 : _a.diagramPadding) !== null && _b !== void 0 ? _b : 8;
  utils.insertTitle(svg, "flowchartTitleText", (conf === null || conf === void 0 ? void 0 : conf.titleTopMargin) || 0, diag.db.getDiagramTitle());
  setupViewPortForSVG(svg, padding, "flowchart", (conf === null || conf === void 0 ? void 0 : conf.useMaxWidth) || false);
...
const newParser = Object.assign({}, parser);
newParser.parse = (src) => {
